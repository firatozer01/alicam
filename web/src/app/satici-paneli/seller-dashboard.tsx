...
type View = "requests" | "offers" | "services" | "visibility" | "profile";
    ...
    <div className={styles.layout}>
      ...
      <section className={styles.content}>
        ...
        {view === "requests" && <section className={styles.viewEnter}>
          ...
          <div className={styles.requestList}>{visibleRequests.length === 0 ? <div className={styles.empty}>Bu filtrede eşleşen talep bulunmuyor.</div> : visibleRequests.map((item, index) => {
